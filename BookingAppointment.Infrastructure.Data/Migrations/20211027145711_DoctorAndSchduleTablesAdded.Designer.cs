...
namespace BookingAppointment.Infrastructure.Data.Migrations
{
    ...
    [Migration("20211027145711_DoctorAndSchduleTablesAdded")]
    partial class DoctorAndSchduleTablesAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingAppointment.Domain.Core.Doctor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingAppointment.Domain.Core.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingAppointment.Domain.Core.Appointment", b =>
                {
                    b.HasOne("BookingAppointment.Domain.Core.User", "User")
            ...
            modelBuilder.Entity("BookingAppointment.Domain.Core.Schedule", b =>
                {
                    b.HasOne("BookingAppointment.Domain.Core.Doctor", "Doctor")
                        .WithMany("Schedules")
